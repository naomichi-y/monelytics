        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="form-group">
              {{!! orm::label('activity_category_id', '科目カテゴリ', array('class' => 'col-md-3 control-label')) !!}
              <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="checkbox-inline">
                  {!! Form::checkbox('credit_flag', App\Models\Activity::CREDIT_FLAG_USE, $credit_flag, array('id' => 'credit_flag_use')) !!}
