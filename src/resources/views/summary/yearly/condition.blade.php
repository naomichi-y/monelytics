            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="radio-inline">
                  {!! Form::radio('output_type', App\Libraries\Condition\YearlySummaryCondition::OUTPUT_TYPE_MONTHLY, $output_type_monthly, array('id' => 'output_type_monthly')) !!}
                  {!! Form::label('output_type_monthly', '月単位') !!}
                </div>
                <div class="radio-inline">
                  {!! Form::radio('output_type', App\Libraries\Condition\YearlySummaryCondition::OUTPUT_TYPE_YEARLY, $output_type_yearly, array('id' => 'output_type_yearly')) !!}
