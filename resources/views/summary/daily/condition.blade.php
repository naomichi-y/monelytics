                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-5">
                                {!! Form::select('activity_category_group_id[]', $activity_category_groups, Request::input('activity_category_group_id'), ['class' => 'form-select', 'multiple' => 'multiple', 'id' => 'activity_category_group_id']) !!}
                            </div>
                        </div>
