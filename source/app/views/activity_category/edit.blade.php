...
<div id="update-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      {{Form::open(array('url' => 'activityCategory/update', 'class' => 'form-horizontal'))}}
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="radio-inline">
                  {{Form::radio('cost_type', ActivityCategory::COST_TYPE_VARIABLE, $cost_type_variable, array('id' => 'cost_type_variable'))}}
                  {{Form::label('cost_type_variable', '変動収支')}}
                </div>
                <div class="radio-inline">
                  {{Form::radio('cost_type', ActivityCategory::COST_TYPE_CONSTANT, $cost_type_constant, array('id' => 'cost_type_constant'))}}
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="radio-inline">
                  {{Form::radio('balance_type', ActivityCategory::BALANCE_TYPE_INCOME, $balance_type_income, array('id' => 'balance_type_income'))}}
                  {{Form::label('balance_type_income', '収入')}}
                </div>
                <div class="radio-inline">
                  {{Form::radio('balance_type', ActivityCategory::BALANCE_TYPE_EXPENSE, $balance_type_expense, array('id' => 'balance_type_expense'))}}
