  ...
  <script>
    $(function() {
      ...
      $(".show-category-group").click(function() {
        var id = $(this).parent().parent().attr("data-id");
        window.location.href = "/activityCategoryGroup?activity_category_id=" + id;
      });
    });
  </script>
@stop
...
@section('content')
  @include('layouts/delete_modal', array('action' => 'activityCategory/delete'))

  <h2>変動収支</h2>
  @include('activity_category/list', array('id' => 'variable', 'activity_categories' => $variable_categories))

  <h2>固定収支</h2>
  @include('activity_category/list', array('id' => 'constant', 'activity_categories' => $constant_categories))
@stop
