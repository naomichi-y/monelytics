              ...
              @endif
                @if (isset($params[$i]))
                  ...
                  <div class="amounts text-right">
                    {{link_to("dailySummary?begin_date={$params[$i]['date']}&amp;end_date={$params[$i]['date']}&amp;cost_type=1", number_format($params[$i]['variable_amount']))}}
                      <br />
                    @if ($params[$i]['constant_amount'])
                      {{link_to("dailySummary?begin_date={$params[$i]['date']}&amp;end_date={$params[$i]['date']}&amp;cost_type=2", number_format($params[$i]['constant_amount']))}}
                    @else
                      &nbsp;
                    @endif
                  </div>
