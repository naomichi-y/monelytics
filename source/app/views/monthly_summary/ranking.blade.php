        ...
        <tbody>
          ...
          @foreach ($location_rankings as $location_ranking)
            <tr>
              ...
              <td>{{HTML::linkWithQueryString('/dailySummary', array('begin_date' => $date_range->begin_date, 'end_date' => $date_range->end_date, 'location' => $location_ranking->location), $location_ranking->location)}}</td>
