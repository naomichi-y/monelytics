...
@section('content')
  @include('layouts/delete_modal', array('action' => 'variableCost/delete'))

  @if ($activities->getTotal())
  {{Form::open(array('url' => 'dailySummary', 'method' => 'get', 'id' => 'list-form'))}}
