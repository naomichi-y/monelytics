...
@section('function')
  <div class="well bs-component">
    {{Form::open(array('url' => 'constantCost/create', 'class' => 'form-horizontal', 'id' => 'search_form', 'method' => 'get'))}}
...
@section('content')
  @include('layouts/delete_modal', array('action' => 'constantCost/delete'))

  @if (sizeof($constant_costs))
    {{Form::open(array('url' => 'constantCost/create'))}}
