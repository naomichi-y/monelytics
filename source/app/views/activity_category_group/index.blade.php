  ...
  <script>
    $(function() {
      ...
      $("#open_create").click(function() {
        $.get("/activityCategoryGroup/create",
          {
      ...
      $("#sortable").sortable({
        stop: function() {
          ...
          $.post("/activityCategoryGroup/sort",
            {
              ids: ids
            }
          );
      ...
      $(".open_edit").click(function() {
        ...
        $.get("/activityCategoryGroup/edit",
          {
            id: id
          },
          function(data) {
  ...
  <div class="well bs-component">
    <div class="row">
      <div class="form-group form-group-sm form-group-adjust">
        <div class="col-md-8">
          {{Form::open(array('url' => 'activityCategoryGroup', 'method' => 'get', 'class' => 'form-horizontal', 'id' => 'search-form'))}}
...
@section('content')
  @include('layouts/delete_modal', array('action' => 'activityCategoryGroup/delete'))
